After being directed to the webpage, the user can choose to login as a property or a HKU student. In both cases, the user needs to enter the id and the name.
